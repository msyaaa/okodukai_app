...
# 目指した課題解決、制作背景（意図）
#### 課題
私は小さい頃からお小遣い帳をつけてお金を管理していました。収支があったらメモするようにしていたのですが、忘れる時もありたまに記入しない時がありました。この経験から、子供が自分でノートなどにしっかりと記録を取って、細かくお金を管理することは難しいと感じました。
#### 解決策
シンプルな操作で、見た目や機能もモチベーションを保てるような簡単にお金の管理ができるものがあると良いと考えました。
<br>
<br>
小学生以下の子供がシンプルなお小遣い帳アプリで、自分で簡単にお金の管理をできるサービスを作ってみようと思いました。
